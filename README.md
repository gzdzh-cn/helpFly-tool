...
| 首页 | 账单列表 | 表单演示 | 图标专栏 |
| --- | --- | --- | --- |
| ![首页-亮色](docs/images/亮色-1.jpg) | ![账单列表-亮色](docs/images/亮色-2.jpg) | ![表单演示-亮色](docs/images/亮色-3.jpg) | ![图标专栏-亮色](docs/images/亮色-4.jpg) |

| 图表分析 | 通用组件 | 参数设置 | 设置页 |
| --- | --- | --- | --- |
| ![图表分析-亮色](docs/images/亮色-5.jpg) | ![通用组件-亮色](docs/images/亮色-6.jpg) | ![参数设置-亮色](docs/images/亮色-7.jpg) | ![设置页-亮色](docs/images/亮色-8.jpg) |

### 界面预览（暗色主题）

| 首页 | 账单列表 | 表单演示 | 图标专栏 |
| --- | --- | --- | --- |
| ![首页-暗色](docs/images/暗色-1.jpg) | ![账单列表-暗色](docs/images/暗色-2.jpg) | ![表单演示-暗色](docs/images/暗色-3.jpg) | ![图标专栏-暗色](docs/images/暗色-4.jpg) |

| 图表分析 | 通用组件 | 参数设置 | 设置页 |
| --- | --- | --- | --- |
| ![图表分析-暗色](docs/images/暗色-5.jpg) | ![通用组件-暗色](docs/images/暗色-6.jpg) | ![参数设置-暗色](docs/images/暗色-7.jpg) | ![设置页-暗色](docs/images/暗色-8.jpg) |
