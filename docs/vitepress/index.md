...
<img src="/images/亮色-1.jpg" alt="首页-亮色" style="display:block;width:100%;max-width:1400px;height:auto">

其余页面：

| 账单列表 | 表单演示 | 图标专栏 | 图表分析 |
| --- | --- | --- | --- |
| ![账单列表-亮色](/images/亮色-2.jpg) | ![表单演示-亮色](/images/亮色-3.jpg) | ![图标专栏-亮色](/images/亮色-4.jpg) | ![图表分析-亮色](/images/亮色-5.jpg) |

| 通用组件 | 参数设置 | 设置页 |
| --- | --- | --- |
| ![通用组件-亮色](/images/亮色-6.jpg) | ![参数设置-亮色](/images/亮色-7.jpg) | ![设置页-亮色](/images/亮色-8.jpg) |

### 暗色主题

首屏预览：

<img src="/images/暗色-1.jpg" alt="首页-暗色" style="display:block;width:100%;max-width:1400px;height:auto">

其余页面：

| 账单列表 | 表单演示 | 图标专栏 | 图表分析 |
| --- | --- | --- | --- |
| ![账单列表-暗色](/images/暗色-2.jpg) | ![表单演示-暗色](/images/暗色-3.jpg) | ![图标专栏-暗色](/images/暗色-4.jpg) | ![图表分析-暗色](/images/暗色-5.jpg) |

| 通用组件 | 参数设置 | 设置页 |
| --- | --- | --- |
| ![通用组件-暗色](/images/暗色-6.jpg) | ![参数设置-暗色](/images/暗色-7.jpg) | ![设置页-暗色](/images/暗色-8.jpg) |

> 点击任意截图即可在文档站内放大查看，按 Esc 或点击遮罩关闭预览。
